package cn.nicenan.mahumall.cart.interceptor;


import cn.nicenan.mahumall.cart.constant.CartConstant;
...
public class CartInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        MemberRespTo user = (MemberRespTo) session.getAttribute(AuthServerConstant.LOGIN_USER);
        if (user != null){
            // 用户登陆了
        ...
        if (StringUtils.isEmpty(userInfoTo.getUserKey())){
            ...
            System.out.println("分配临时用户" + uuid);
