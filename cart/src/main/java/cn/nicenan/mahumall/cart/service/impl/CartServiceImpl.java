...
public class CartServiceImpl implements CartService {
    ...
    @Override
    public Cart getCart() throws ExecutionException, InterruptedException, JsonProcessingException {
    ...
    @Override
    public void changeItemCount(Long skuId, Integer num) throws JsonProcessingException {
        CartItem cartItem = getCartItem(skuId);
        cartItem.setCount(num);
        BoundHashOperations<String, Object, Object> cartOps = getCartOps();
        cartOps.put(skuId.toString(), objectMapper.writeValueAsString(cartItem));
    ...
    @Override
    public BigDecimal toTrade() throws ExecutionException, InterruptedException, JsonProcessingException {
