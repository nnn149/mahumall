...
/**
 * 远程调用
 * 1.引入open-feign依赖  SpringCloud新版本需要在Common中排除Ribbon依赖，微服务模块添加loadbalancer依赖 https://blog.csdn.net/weixin_43556636/article/details/110653989
 * 2.编写接口（新建feign包），告诉SpringCloud这个接口需要调用远程服务
